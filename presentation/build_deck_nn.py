...
set_text(body_box, [
    ...
    "• 665 утверждений: строгая JSON-схема, дословная цитата хранится в узле графа",
    "• Строгий AND: пересечение документов по всем числовым условиям сразу (8 из 1828)",
...
add_box(s, 0.4, 1.95, 9.0, 3.4, [
    ...
    "• 665 LLM-утверждений: цитата не совпала → в граф не попадает; прошла — хранится в узле",
    ...
    "• Прослеживаемость: любой ответ → узел графа → дословная строка документа",
