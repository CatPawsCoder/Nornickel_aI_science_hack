...
add_box(s, 0.4, 1.95, 9.0, 3.3, [
    "• 292 155 чисел: каждое дословно найдено в источнике (string-match), 0 исключений",
    "• 665 LLM-утверждений: цитата не совпала → в граф не попадает (отсеяно автоматически)",
    "• Уровни достоверности: высокая / средняя / низкая + статус (active / superseded)",
    "• Зоны разногласий: 3 000 автоматических рёбер «источники расходятся»",
    "• Пробелы в знаниях: система честно говорит, чего в корпусе нет",
    "• Аудит: любой ответ прослеживается до узла графа и строки документа",
], size=14, color=GREY)
